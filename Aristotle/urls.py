...
urlpatterns = patterns(
    ...
    url(r'^user/(?P<user_id>[a-z0-9]+)', views.UserProfileView.as_view(),
        name='user-setting-view'),
    url(r'^question/(?P<question_id>[a-z0-9]+)/', views.QuestionView.as_view(),
        name='question-view'),
    url(r'^answer/(?P<question_id>[a-z0-9]+)/', views.AnswerView.as_view(),
        name='answer-view'),
